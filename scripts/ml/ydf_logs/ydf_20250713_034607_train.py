...
with open('ydf_logs/ydf_20250713_034607.log', 'w', buffering=1) as log_file:
    sys.stdout = log_file
    sys.stderr = log_file
    
    try:
        # Load data
        train_data = pd.read_pickle('ydf_logs/ydf_20250713_034607_train.pkl')
        valid_data = pd.read_pickle("ydf_logs/ydf_20250713_034607_valid.pkl")
        
        # Recreate learner
        import json
        with open('ydf_logs/ydf_20250713_034607_learner.pkl', 'r') as f:
            config = json.load(f)
        ...
        # Save model
        model.save('ydf_logs/ydf_20250713_034607_model')
